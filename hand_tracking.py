...
class Tracker:
    def __init__(self, static_image_mode=False, max_num_hands=1, 
        ...
        self.tracking_id = [4, 12]  # Thumb tip and Index finger tip IDs
        ...
        if self.results.multi_hand_landmarks:
            for hand_landmarks in self.results.multi_hand_landmarks:
                ...
                for landmark in hand_landmarks.landmark:
                    ...
                    cv2.circle(mask, (x, y), 10, (255), cv2.FILLED)
        
        blurred_img = cv2.GaussianBlur(img, (55, 55), 0)
        img = np.where(mask[:, :, None] == 255, img, blurred_img)
        return img
    ...
    def tracking(self, img):
        ...
        if self.results.multi_hand_landmarks:
            ...
            x_c = (x1 + x2) // 2
            y_c = (y1 + y2) // 2
            cv2.line(img, (x1, y1), (x2, y2), (255, 255, 255), 3)  # Change line color to white
